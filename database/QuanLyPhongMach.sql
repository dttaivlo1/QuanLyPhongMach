...
insert into BacSi(tenBS,username,password) values(N'Dương Tấn Tài','dttai','123456')
insert into BacSi(tenBS,username,password) values(N'Trần Ngọc Thạch','thphuoc','123456')
insert into BacSi(tenBS,username,password) values(N'Phạm Minh Khôi','pmkhoi','123456')
select * from BacSi
